                ...
                <asp:TreeView ID="TreeView1" runat="server" Height="114px" ImageSet="BulletedList4" ShowExpandCollapse="False" Width="222px">
                    ...
                    <Nodes>
                        <asp:TreeNode Text="Consultas del sistema" Value="Consultas del sistema">
                            <asp:TreeNode NavigateUrl="~/Cliente/ConsultaCliente.aspx" Text="Facturas pendientes" Value="Facturacion del cliente"></asp:TreeNode>
                            ...
                            <asp:TreeNode Text="Consultar Facturas por Cliente" Value="Listado paginado de Facturas" NavigateUrl="~/Mantenimiento/Factura/ConsultasFacturas.aspx"></asp:TreeNode>
