...
using ProyAutoServicios_GUI;

namespace ProyAutoServicio_GUI
{
            ...
            if(txtLogin .Text.Trim() != "" & txtPassword.Text.Trim() != "")
             {
                ...
                if(objUsuarioBE.Name_Usuario == null)
                {
                ...
                else if (txtLogin.Text.Trim() == objUsuarioBE.Name_Usuario & txtPassword.Text.Trim() == objUsuarioBE.Pass_Usuario)
                {
                    this.Hide();
                    timer1.Enabled = false;

                    //regsitramos las credenciales
                    clsCredenciales.Usuario = objUsuarioBE.Name_Usuario;
                    clsCredenciales.Password = objUsuarioBE.Pass_Usuario;
                    clsCredenciales.Nivel = objUsuarioBE.Nivel_Usuario;


                    //Lanzamos el MDI
                    MDIMenu objMDI = new MDIMenu();
                    objMDI.ShowDialog();
                }
